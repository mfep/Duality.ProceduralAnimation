        ...
        protected override AnimBuilder InitializePieces()
        {
            return AnimBuilder.Start()
                .AddParalell( new IAnimPiece[]
                    {
                        new PathFollowMovement { Closed = true, Relative = true, Smoothing = PathFollowMovement.SmoothMode.SmoothSections, ConstantVelocity = true,
                            PathVertices = new []{ new Vector2(-2500, 0), new Vector2(0,-1500),  new Vector2(2500, 0), new Vector2(0, 1500) } },
